                        ...
                        <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0,0.8)] overflow-hidden'>
                            ...
                            <div className='relative px-8 pt-14 pb-10 text-center'>
                                ...
                                <h2 className='text-3xl font-semibold leading-tight mb-3 space-x-2 '>
                                    ...
                                    <span className='bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent'>Vision AI</span>
                                </h2>
                                <motion.button
                                    ...
                                    <div className='relative flex items-center justify-center gap-3'>
                                        <img src="https://thumbs.dreamstime.com/b/google-logo-vector-format-white-background-illustration-407571048.jpg" alt="" className='h-5 w-5' />
